...
public class PopulationController {
    ...
    public String populations(Model model, @PathVariable("id") Long id){
        ...
        Population populationByRelationship=populationService.findByResidenceIdAndRelationship(residenceBooklet);
        ...
        model.addAttribute("populationByRelationship",populationByRelationship);
